...
exports.patientAppointmentStatusUpdateTemplate = exports.doctorAppointmentPendingTemplate = exports.patientAppointmentPendingTemplate = void 0;
const patientAppointmentPendingTemplate = (appointmentDetails) => {
    return `<!DOCTYPE html>
    <html>
      <head>
        <meta charset="UTF-8" />
...
exports.patientAppointmentPendingTemplate = patientAppointmentPendingTemplate;
const doctorAppointmentPendingTemplate = (appointmentDetails) => {
    return `<!DOCTYPE html>
    <html>
      <head>
        <meta charset="UTF-8" />
...
exports.doctorAppointmentPendingTemplate = doctorAppointmentPendingTemplate;
const patientAppointmentStatusUpdateTemplate = (appointmentDetails) => {
    const statusTextMap = {
        CONFIRMED: 'confirmed',
        CANCELLED: 'cancelled',
        COMPLETED: 'completed',
...
exports.patientAppointmentStatusUpdateTemplate = patientAppointmentStatusUpdateTemplate;
