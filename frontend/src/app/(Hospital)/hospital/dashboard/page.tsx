          ...
          <>
            {isProfileComplete === false && (
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  Your hospital profile is incomplete. Please complete your profile to access all features.
                </AlertDescription>
              </Alert>
            )}
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              ...
              <Card className="overflow-hidden border-none shadow-md bg-gradient-to-br from-blue-50 to-white dark:from-blue-950/40 dark:to-background">
                <CardHeader className="pb-2">
                  ...
                  <CardDescription>Manage hospital doctors</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className="overflow-hidden border-none shadow-md bg-gradient-to-br from-purple-50 to-white dark:from-purple-950/40 dark:to-background">
                <CardHeader className="pb-2">
                  ...
                  <CardDescription>Manage hospital appointments</CardDescription>
                </CardHeader>
                <CardContent>
